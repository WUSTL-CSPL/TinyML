...
//my__SXTAB16_RORn
__STATIC_FORCEINLINE uint32_t my__SXTAB16_RORn(uint32_t op1, uint32_t op2, uint32_t rotate)
{
  uint32_t result;
...
//my1my2__SXTB16_RORn
__STATIC_FORCEINLINE uint32_t my2__SXTB16_RORn(uint32_t op1, uint32_t rotate)
{
  uint32_t result;
  if (__builtin_constant_p(rotate) && ((rotate == 8U) || (rotate == 16U) || (rotate == 24U))) {
                                             ...
                                             const int32_t address_offset)
{
    ...
    for (int32_t i = 0; i < row_loop_cnt; i++)
    {
        ...
        for (int j = col_loop_cnt; j != 0; j--)
        {
            ...
            int32_t vec_1 = my__SXTAB16_RORn(lhs_offset_s16x2, (uint32_t)vec_0, 8);

            vec_0 = __SXTAB16(lhs_offset_s16x2, vec_0);

            int32_t ker_0 = arm_nn_read_q7x4_ia(&rhs_0);
            int32_t ker_1 = my2__SXTB16_RORn((uint32_t)ker_0, 8);
            ...
            ker_1 = my2__SXTB16_RORn((uint32_t)ker_0, 8);
            ker_0 = __SXTB16(ker_0);
